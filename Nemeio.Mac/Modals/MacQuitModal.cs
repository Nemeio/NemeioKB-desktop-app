...
{
    public class MacQuitModal : MacModalWindow<QuitViewController>
    {
        ...
        public MacQuitModal(ILanguageManager languageManager, IActiveLayoutChangeHandler activeLayoutChangeHandler, IKeyboardController keyboardController)
