...
{
    internal sealed class TestCommandHandlerController : ITestCommandHandlerController
    {
        private readonly ILogger _logger;
        private readonly IList<ICommandHandler> _commandHandlers;

        public TestCommandHandlerController(ILoggerFactory loggerFactory, IList<ICommandHandler> commandHandlers)
        {
