...
{
    public sealed class WinQuitModal : IModalWindow
    {
        ...
        public WinQuitModal(IActiveLayoutChangeHandler activeLayoutChangeHandler, IKeyboardController keyboardController)
        {
